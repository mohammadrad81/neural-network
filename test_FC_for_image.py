...
list_of_2_images_file_names = os.listdir("datasets/MNIST/2/")[:200]
list_of_5_images_file_names = os.listdir("datasets/MNIST/5/")[:200]
...
model = Model(
    ...
    optimizer=GD(layers_list=layers_list, learning_rate=0.0001)
)
